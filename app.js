...
var num1 = changeToEng('١٠');
var num2 = changeToEng('١٠')
console.log(changeToKrd(num1+num2))
...
document.getElementById('btnEvent').addEventListener('click',()=>{
  ...
  num1 = changeToEng(num1)
  num2 = changeToEng(num2)
  document.getElementById('anjam').innerText = changeToKrd(num1+num2)
})
